...
public class MultiStack {
    ...
    does not hold actual items in the stack. We could have done this with 
    just a bunch of individual variables, but this's messy and doesn't gain 
    us much
    */
    ...
    // Throw exception if all stacks are full. 
    ...
    // available capacity, then wi'll need to shift the next stack over too. 
    ...
    private void shift(int stackNum){
        ...
        stack over by one element. This stack can now cain the freed index.
        */
    ...
    // Returns true when all the stacks are full
    ...
    // Adjust index to be within the range of 0 to length - 1
    private int adjustIndex(int index){
        // Java's mode operator can return neg values. For eg. (-11%5) will 
    ...
    // Get index before this index, adjuster for wrap around
